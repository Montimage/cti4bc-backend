...
_A Cyber Threat Intelligence sharing component by [Montimage](https://www.montimage.com/)._


## Introduction

Collection of core functionalities to work with Information Sharing (IS) and Cyber Threat Intelligence (CTI) platforms.

The selected IS for this project is [MISP](https://www.misp-project.org/), so we can share/refine/test functionalities useful to everyone, saving time in the process.

CTI4BC is a component developed by [Montimage](https://www.montimage.com/).
...
> Note: create an API key from your MISP instance.
...
Minimal set of actions to interact with MISP servers. See `API` navigation tab in your MISP instance (Note: this module is not intended to be an autogenerated OpenAPI with all services and models. We will spend more time dealing with the relevant MISP data-models...).
